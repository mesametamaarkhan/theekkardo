                ...
                <div className="bg-white rounded-xl shadow-md p-6 mb-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p className="font-medium">{serviceRequest.service}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-600">Vehicle</p>
                            <p className="font-medium">{serviceRequest.vehicle}</p>
                        </div>
                        <div>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <p className="font-medium">{serviceRequest.issue}</p>
                        </div>
                    </div>
                </div>
                        ...
                        >
                            <div className="flex items-start justify-between">
                                <div className="flex items-start space-x-4">
                                    <img
                                        src={bid.avatar}
                                        alt={bid.mechanicName}
                                        className="w-12 h-12 rounded-full object-cover"
                                    />
                                    <div>
                                        <h3 className="font-semibold text-lg">{bid.mechanicName}</h3>
                                        <div className="flex items-center space-x-4 text-sm text-gray-600">
                                            <div className="flex items-center">
                                                <Star className="w-4 h-4 text-yellow-400 mr-1" />
                                                <span>{bid.mechanicRating}</span>
                                            </div>
                                            <div className="flex items-center">
